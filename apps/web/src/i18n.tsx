...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "question.resolving": "Sending…",
    "question.error": "Could not send. Try again.",
    "common.back": "← Back",
    ...
    "threads.actions": "Actions for {title}",
    "threads.details.edit": "Edit details",
    "threads.details.title": "Title",
    "threads.details.purpose": "Purpose (optional)",
    "threads.details.purposePlaceholder":
      "One line to help you recognize and find this Conversation",
    "threads.details.save": "Save",
    "threads.details.cancel": "Cancel",
    "threads.moveGroup": "Organize / move",
    "threads.unsorted": "Unsorted",
    "threads.noChats": "No Conversations yet",
    "settings.projects.tab": "Organization",
  ...
  zh: {
    "question.other": "其他答案",
    "question.placeholder": "输入你的答案",
    "question.send": "发送答案",
    "question.skip": "跳过",
    "question.answered": "已回答：",
    "question.skipped": "已跳过：",
    "question.resolving": "正在发送…",
    "question.error": "发送失败，请重试。",
    ...
    "threads.actions": "“{title}”的操作",
    "threads.details.edit": "编辑资料",
    "threads.details.title": "标题",
    "threads.details.purpose": "用途（可不填）",
    "threads.details.purposePlaceholder":
      "用一句话说明，方便辨认和搜索这段对话",
    "threads.details.save": "保存",
    "threads.details.cancel": "取消",
    "threads.moveGroup": "整理 / 移动",
    "threads.unsorted": "未分类",
    "threads.noChats": "还没有对话",
    "settings.projects.tab": "整理",
