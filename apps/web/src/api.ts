...
export function fetchTaskProgress(id: string): Promise<TaskRunProgress | null> {
  return requestJson<TaskRunProgress | null>(
    `/v1/tasks/${encodeURIComponent(id)}/progress`,
  );
}
