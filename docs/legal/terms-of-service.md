...
18.1 **Changes to the Software and Operator Services.** We may modify, suspend or discontinue part of the Software or Operator Services where reasonably necessary for security, legal, operational or project-sustainability reasons. We will act reasonably and proportionately and, except where urgent action is reasonably necessary or circumstances are outside our reasonable control, give reasonable advance notice of a material suspension or discontinuance. This does not remove Software already installed on your device or affect accrued or non-excludable rights.
